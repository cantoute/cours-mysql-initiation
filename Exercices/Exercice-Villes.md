...
5. Obtenir la liste du nom de chaque département, associé à son code et du nombre de communes au sein de ces départements, en triant afin d’obtenir en priorité les départements qui possèdent le plus de communes.
